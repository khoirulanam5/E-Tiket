...
<script>
  ...
  $(function () {
    ...
    $("#BTN_SAVE").click(function(){
      ...
      if(save_method == 'save') {
          urlPost = "<?= site_url('penjualan/saveData') ?>";
      }else{
          urlPost = "<?= site_url('penjualan/updateData') ?>";
  ...
  function REFRESH_DATA(){
    ...
    var tb_data = $("#tb_data").DataTable({
      ...
      "pageLength": 25,
      "ajax": {
          "url": "<?= site_url('penjualan/getAllData') ?>",
          "type": "GET"
      },
      "columns": [
          {
  ...
  function editData(data, index){
    ...
    $.ajax({
      url: "<?= site_url('penjualan/getPenjualanByID') ?>",
      type: "POST",
      data: {
  ...
  function deleteData(id){
    ...
    urlPost = "<?= site_url('penjualan/deleteData') ?>";
  ...
  function ISI_TUJUAN(){
    $.ajax({
      url: "<?= site_url('penjualan/getTujuanBus') ?>",
      type: "POST",
      data: {
  ...
  function ISI_NM_PELANGGAN(){
    $.ajax({
      url: "<?= site_url('penjualan/getNamaPelanggan') ?>",
      type: "POST",
      data: {
