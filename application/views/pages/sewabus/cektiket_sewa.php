        ...
        <div class="col-12">
          <div class="card card-default collapsed-card"  style="margin-top: 1rem">
            <div class="card-header">
              <h3 class="card-title">Ketersediaan Sewa Bus</h3>
      ...
      <div class="row">
        <div class="col-4">
          <div class="card" style="margin-top: 1rem">
            <form id="FRM_DATA">
              <div class="card-header">
                <h3 class="card-title">Cek Tiket Sewa</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="form-group">
                  <h5>Masukkan Nomor Penyewaan</h5>
                  <input type="text" class="form-control" name="id_sewa_bus">
                </div>
              </div>
              <!-- /.card-body -->
        ...
        <div class="col-8" id="lst_show" style="display: none;">
          <div class="card" style="margin-top: 1rem">
            ...
            <!-- /.card-body -->
            <div class="card-footer text-right">
              <button type="submit" class="btn btn-info" id="BTN_CLOSE">Close</button>
            </div>
          </div>
          <!-- /.card -->
        </div>
...
<script>
  ...
  $(function(){
    $("#FRM_DATA").on('submit', function(event){
      ...
      $.ajax({
        url: "<?= site_url('sewabus/ketersediaan_bus/getTiketById') ?>",
        type: "POST",
        data: {
  ...
  function REFRESH_DATA(){
    $.ajax({
      url: "<?= site_url('sewabus/ketersediaan_bus/getJadwalByDate') ?>",
      dataType: "JSON",
      type: "POST",
      data: {
