          ...
          <form id="FRM_DATA">
            ...
            <div class="modal-body">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="nm_jenis_bus_sewa" rows="2"></textarea>
                </div>
              </div>
...
<script>
  ...
  $(function () {
    ...
    $("#BTN_SAVE").click(function(){
      ...
      if(save_method == 'save') {
          urlPost = "<?= site_url('sewabus/jenis_bus_sewa/saveData') ?>"; // URL untuk save data baru
      }else{
          urlPost = "<?= site_url('sewabus/jenis_bus_sewa/updateData') ?>"; // URL untuk update data
          formData+="&id_jenis_bus_sewa="+id_edit // Menambahkan ID data yang akan diedit
      }
  ...
  function REFRESH_DATA(){
    ...
    var tb_data = $("#tb_data").DataTable({
      ...
      "pageLength": 25,
      "ajax": {
          "url": "<?= site_url('sewabus/jenis_bus_sewa/getAllData') ?>", // URL untuk mengambil data
          "type": "GET"
      },
      "columns": [
          {
          ...
          { "data": "id_jenis_bus_sewa" },
          { "data": "nm_jenis_bus_sewa" },
          { "data": null, 
              ...
              return `
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Aksi</button>
                  <ul class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="#" onclick='deleteData("${data.id_jenis_bus_sewa}");'><i class='fas fa-trash'></i> Delete</a>
                  </ul>
                </div>
              `
            },
  ...
  function editData(data){
    ...
    id_edit = data.id_jenis_bus_sewa;

    $("#modal_add .modal-title").text('Edit Data') // Mengubah judul modal
    $("[name='nm_jenis_bus_sewa']").val(data.nm_jenis_bus_sewa) // Mengisi form dengan data
    $("#modal_add").modal('show') // Menampilkan modal
  }
  ...
  function deleteData(id){
    ...
    urlPost = "<?= site_url('sewabus/jenis_bus_sewa/deleteData') ?>"; // URL untuk delete data
    formData = "id_jenis_bus_sewa="+id
