                  ...
                  <form >
                    <div class="d-md-flex mt-2">
                      ...
                      <div class="form-group col-12 col-md-4">
                        ...
                        <input type="text" class="form-control date" name="tgl_keberangkatan" onChange="ISI_TUJUAN()" placeholder="Masukan Tanggal">
                      </div>
                      <div class="form-group col-12 col-md-4">
            ...
            <table class="table">
              <thead class="thead-primary">
                <tr class="text-center">
                  ...
                  <th class="bg-black heading">Jumlah Bus</th>
                </tr>
              </thead>
              <tbody id="tbData">
              </tbody>
...
<script>
  ...
  function ISI_TUJUAN(){
    $.ajax({
      url: "<?= site_url('penjualan/getPariwisata') ?>",
      type: "POST",
      data: {
  ...
  function ISI_TABLE(){
    $.ajax({
      url: "<?= site_url('/front/getKetersediaanBus') ?>",
      type: "POST",
      dataType: "HTML",
      data:{
        tgl_berangkat: $("[name='tgl_keberangkatan']").val(),
