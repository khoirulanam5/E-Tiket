...
<div id="container">
  ...
  <p>Periode : <?= $period_start." Sampai ".$period_end; ?></p>
    <table border="1" style="width:100%;font-size:12px;border: 1px solid #ddd;border-collapse: collapse;">
	  	...
	  	<tbody>
		  	<?php $no=1;$total=0; ?>
				...
				<tr>
					...
					<td style="text-align: center;"><?= $row['id_penjualan_tiket']; ?></td>
					<td style="text-align: center;"><?= $row['id_tiket_bus']; ?></td>
          ...
          <td style="text-align: center;"><?= $row['jenis_penjualan_tiket']; ?></td>
		...
		<tfoot>
            <tr>
                <td colspan="10" style="text-align:center;"><b>Total Bayar</b></td>
